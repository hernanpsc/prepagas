...
export const RANKING_DATA_ITEMS: Ranking[] = [
	{
		id: 1,
		image: '/assets/images/salud/medife.webp',
		interestRate: 9.81,
		approvalTime: 72,
		procedures: 'corto',
		rating: 99,
	...
	{
		id: 2,
		image: '/assets/images/salud/sancorsalud.webp',
		interestRate: 8.65,
		approvalTime: 52,
		procedures: 'extenso',
		rating: 85,
	...
	{
		id: 3,
		image: '/assets/images/salud/avalian.webp',
		interestRate: 12.81,
		approvalTime: 100,
		procedures: 'normal',
		rating: 75,
	...
	{
		id: 4,
		image: '/assets/images/salud/galeno.webp',
		interestRate: 10.81,
		approvalTime: 70,
		procedures: 'corto',
		rating: 45,
