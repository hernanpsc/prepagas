...
export const INTERNAL_PATHS = {
	 ...
	 *  * ASESORI - INSURANCE
	 */
	ASESORI_SALUD_DEFAULT: `${ROUTES_PATHS.ASESORI.SALUD.DEFAULT}`,
	ASESORI_SALUD_RESULTS: `${ROUTES_PATHS.ASESORI.SALUD.RESULTS}`,
	ASESORI_SALUD_DETAILS: `${ROUTES_PATHS.ASESORI.SALUD.DETAILS}`,
	ASESORI_SALUD_COMPARE: `${ROUTES_PATHS.ASESORI.SALUD.COMPARE}`,
	ASESORI_SALUD_EMPRESA: `${ROUTES_PATHS.ASESORI.SALUD.EMPRESA}`,
...
export const INTERNAL_ROUTES = {
	 ...
	 * ASESORI - SALUD
	 */
	ASESORI_SALUD_DEFAULT: `/${INTERNAL_PATHS.ASESORI_SALUD_DEFAULT}`,
	ASESORI_SALUD_RESULTS: `/${INTERNAL_PATHS.ASESORI_SALUD_DEFAULT}/${INTERNAL_PATHS.ASESORI_SALUD_RESULTS}`,
	ASESORI_SALUD_DETAILS: `/${INTERNAL_PATHS.ASESORI_SALUD_DEFAULT}/${INTERNAL_PATHS.ASESORI_SALUD_RESULTS}/${INTERNAL_PATHS.ASESORI_SALUD_DETAILS}`,
	ASESORI_SALUD_COMPARE: `/${INTERNAL_PATHS.ASESORI_SALUD_DEFAULT}/${INTERNAL_PATHS.ASESORI_SALUD_RESULTS}/${INTERNAL_PATHS.ASESORI_SALUD_COMPARE}`,
	ASESORI_SALUD_EMPRESA: `/${INTERNAL_PATHS.ASESORI_SALUD_DEFAULT}/${INTERNAL_PATHS.ASESORI_SALUD_RESULTS}/${INTERNAL_PATHS.ASESORI_SALUD_EMPRESA}`,
